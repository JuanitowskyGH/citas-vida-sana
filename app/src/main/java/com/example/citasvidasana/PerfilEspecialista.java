...
import com.example.citasvidasana.databinding.ActivityPerfilEspecialistaBinding;
...
public class PerfilEspecialista extends DrawerBaseEspecialista {

    ActivityPerfilEspecialistaBinding activityPerfilEspecialistaBinding;
    private EditText etNombre, etApellidop, etApellidom, etTelefono, etCorreo, etPass, etCpass;
    private TextView tvCedula, tvEspecialidad;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        activityPerfilEspecialistaBinding = ActivityPerfilEspecialistaBinding.inflate(getLayoutInflater());
        setContentView(activityPerfilEspecialistaBinding.getRoot());
            ...
            public void onClick(View v) {
                ...
                if(nom.equals("")){
                    ...
                    if (passw.equals("")) {
                        ...
                        DocumentReference usuarioRef = db.collection("Especialistas").document(userId);
